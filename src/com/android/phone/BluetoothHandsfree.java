...
public class BluetoothHandsfree {
    ...
    private AtCommandResult redial() {
        BluetoothAtPhonebook.PhoneNumberSub  numsub = mPhonebook.getLastDialledNumber();
        if (numsub == null || numsub.number == null) {
        ...
        Intent intent = new Intent(Intent.ACTION_CALL_PRIVILEGED,
                Uri.fromParts(Constants.SCHEME_TEL, numsub.number, null));
        ...
        if (numsub.sub != INVALID_SUB)
            intent.putExtra(SUBSCRIPTION_KEY,numsub.sub);
