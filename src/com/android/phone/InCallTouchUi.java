...
import com.android.phone.SlidingTab;
import com.android.phone.RespondViaSmsManager.RespondViaSmsItemClickListener;
...
public class InCallTouchUi extends FrameLayout
        ...
        /* Begin: Modified by zxiaona for incomingcall_screen 2012/05/25 */
        // OnTriggerListener,
        SlidingTab.OnTriggerListener,
        /* End: Modified by zxiaona for incomingcall_screen 2012/05/25 */
    ...
    /*Begin: Modified by zxiaona for bug for incoming 2012/07/12*/
    ...
    private static final int SEND_SMS_ID = 0;  // drag up
    /*End: Modified by zxiaona for bug for incoming 2012/07/12*/
    ...
    /* Begin: Modified by zxiaona for incomingcall_screen 2012/05/24 */
    // private MultiWaveView mIncomingCallWidget; // UI used for an incoming
    // call
    ...
    /* End: Modified by zxiaona for incomingcall_screen 2012/05/24 */

    private View mInCallControls;  // UI elements while on a regular call
    //
    private ImageButton mAddButton;
    private ImageButton mMergeButton;
    /* Begin: Modified by zxiaona for call_screen_sim 2012/05/22 */
    // private ImageButton mEndButton;
    private CompoundButton mEndButton;
    /* End: Modified by zxiaona for call_screen_sim 2012/05/22 */
    ...
    /* Begin: Modified by zxiaona for callScreen_btnicon 2012/05/31 */
    private CompoundButton mSpeakerButton;
    private CompoundButton mBlueButton;
    /* End: Modified by zxiaona for callScreen_btnicon 2012/05/31 */
    /* Begin: Modified by zxiaona for mutil_call 2012/08/03 */
    private CompoundButton mcdmaMergeButtonImage;
    ...
    protected void onFinishInflate() {
        ...
        /* Begin: Modified by zxiaona for incomingcall_screen 2012/05/24 */
        // mIncomingCallWidget = (MultiWaveView)
        // findViewById(R.id.incomingCallWidget);
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<String>(getContext(),
                                         ...
                                         android.R.id.text1,
                                         mCannedResponses);
        View headview = mLayoutInflater.inflate(R.layout.list_head_view, null);
        headview.setClickable(false);
        mListView.addHeaderView(headview);
        mListView.setBackgroundResource(R.drawable.call_incoming_reject_list);
        ...
        /* Begin: Modified by zxiaona for call_screen_sim 2012/05/22 */
        // mEndButton = (ImageButton)
        // mInCallControls.findViewById(R.id.endButton);
        mEndButton = (CompoundButton) mInCallControls.findViewById(R.id.endButton);
        /*Begin: Modified by zxiaona for incomingcall_screen 2012/05/24*/
        setendIcon(false);
        /*End: Modified by zxiaona for incomingcall_screen 2012/05/24*/
        /* End: Modified by zxiaona for call_screen_sim 2012/05/22 */
        ...
        /* Begin: Modified by zxiaona for callScreen_btnicon 2012/05/31 */
        mSpeakerButton = (CompoundButton) mInCallControls.findViewById(R.id.speakerButton);
        mSpeakerButton.setOnClickListener(this);
        mBlueButton = (CompoundButton) mInCallControls.findViewById(R.id.bluetoothButton);
        ...
        //
        //      if (PhoneApp.getInstance().getPhone().getPhoneType() == Phone.PHONE_TYPE_CDMA) {
    ...
    void updateState(CallManager cm) {
        ...
        if (showInCallControls) {
            ...
            /* Begin: Modified by zxiaona for IncomingCall bug 2012/06/08 */
            if (fgCallState.isDialing()) {
                mIncomingCallWidget.setVisibility(View.GONE);
                mSlidingDrawer.close();
                mSlidingDrawer.setVisibility(View.GONE);
            }
            /* End: Modified by zxiaona for IncomingCall bug 2012/06/08 */
    ...
    void updateInCallControls(CallManager cm) {
        ...
        if (inCallControlState.canEndCall) {
            mEndButton.setText(R.string.onscreenEndCallText);
            setendIcon(false);
        } else if (inCallControlState.endDisconn) {
            mEndButton.setText(R.string.onscreenEndCallText);
            Drawable mend = getResources().getDrawable(R.drawable.call_end_call_icon_dim);
            mend.setBounds(0, 0, mend.getMinimumWidth(), mend.getMinimumHeight());
            mEndButton.setCompoundDrawables(null, mend, null, null);
        } else if (inCallControlState.isShowEnable) {
                mEndButton.setEnabled(true);
                mEndButton.setText(R.string.onscreenEndCallText);
                Drawable mend = getResources().getDrawable(R.drawable.call_cancel_icon);
                mend.setBounds(0, 0, mend.getMinimumWidth(), mend.getMinimumHeight());
                mEndButton.setCompoundDrawables(null, mend, null, null);
            } else {
            mEndButton.setText(R.string.cancel);
            setendIcon(true);
        }
        ...
        mMuteButton.setEnabled(inCallControlState.canMute);
        // "Speaker"
        mSpeakerButton.setEnabled(inCallControlState.canSpeaker);
        // "Blutooth"
        mBlueButton.setEnabled(inCallControlState.isOkBluth);
        /* End: Modified by zxiaona for callScreen_btnicon 2012/06/01 */
        ...
        // given point exactly one of them must be VISIBLE and the other
        // must be GONE.
        /* Begin: Modified by zxiaona for inComingCallScreen 2012/06/05 */
        ...
        /* End: Modified by zxiaona for inComingCallScreen 2012/06/05 */
        ...
        /*Begin: Modified by zxiaona for mutil_call 2012/08/03*/
        mcdmaMergeButtonImage = (CompoundButton) findViewById(R.id.cdmaMergeButtonImage);
        mcdmaMergeButtonImage.setOnClickListener(this);
        /*End: Modified by zxiaona for mutil_call 2012/08/03*/
        ...
        if (showCdmaMerge) {
            ...
            mCdmaMergeButton.setVisibility(View.GONE);
            mcdmaMergeButtonImage.setVisibility(View.GONE);
            mHoldButton.setVisibility(View.VISIBLE);
            /*End: Modified by zxiaona for mutil_call 2012/08/03*/
    ...
    private void hideIncomingCallWidget() {
        ...
        anim.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                mIncomingCallWidget.setVisibility(View.GONE);
                /*Begin: Modified by zxiaona for incomingcall_screen 2012/05/26*/
                mSlidingDrawer.setVisibility(View.GONE);
                /*End: Modified by zxiaona for incomingcall_screen 2012/05/26*/
    ...
    public void setSlidingDrawer(Call ringingCall) {
        Phone p = ringingCall.getPhone();
        int subscription = p.getSubscription();
        Log.i("-----------------------", "subscription" + subscription);
        mListView.setOnItemClickListener(new RespondViaSmsItemClickListener(phoneNumber,
                subscription));
    }
    ...
    public class RespondViaSmsItemClickListener implements AdapterView.OnItemClickListener {
        ...
        public RespondViaSmsItemClickListener(String phoneNumber, int subscription) {
        ...
        public void onItemClick(AdapterView<?> parent, // The ListView
            ...
            if (position == 0) {
                ...
                // Send the selected message immediately with no user
                // interaction.
                sendText(mPhoneNumber, message, mSubscription);
                ...
                Log.i("-----------------------", "confirmationMsg " + confirmationMsg);
    ...
    private void sendText(String phoneNumber, String message, int subscription) {
        ...
        if (mInCallScreen != null) {
            ...
            /* Begin: Modified by zxiaona for incomingcall_screen 2012/05/25 */
                        ...
                        case SlidingTab.OnTriggerListener.RIGHT_HANDLE:
                            ...
                            //hintColorResId = R.color.incall_textEnded;  // red // red
                            /*End: Modified by zxiaona for bug for incoming 2012/07/12*/
    ...
    /* Begin: Modified by zxiaona for dialpad 2012/05/12 */
    public void setholdIcon(boolean canHold) {
        Drawable mhold = null;
        if(canHold == false) {
         mhold = getResources().getDrawable(R.drawable.hold002);
        } else {
            mhold = getResources().getDrawable(R.drawable.call_stop_call_icon_dim);
        }
        mhold.setBounds(0,0, mhold.getMinimumWidth(), mhold.getMinimumHeight());
        mHoldButton.setCompoundDrawables(null, mhold, null, null);
    }

    public void setendIcon(boolean canEnd) {
        Drawable mend = null;
        if (canEnd == false) {
            mend = getResources().getDrawable(R.drawable.endcall);
        } else {
            mend = getResources().getDrawable(R.drawable.call_cancel_icon);
        }
        mend.setBounds(0, 0, mend.getMinimumWidth(), mend.getMinimumHeight());
        mEndButton.setCompoundDrawables(null, mend, null, null);
    }
    // Debugging / testing code
    /* End: Modified by zxiaona for dialpad 2012/05/12 */
    private void log(String msg) {
        Log.d(LOG_TAG, msg);
    }

    /* Begin: Modified by zxiaona for incomingcall_screen 2012/05/24 */
    public String[] loadCannedResponses() {
        if (DBG)
            log("loadCannedResponses()...");
        SharedPreferences prefs =
                getContext().getSharedPreferences(SHARED_PREFERENCES_NAME,
    ...
    /* Begin: Modified by zxiaona for display dialpad drawabletop 2012/06/12 */
    public void hideDialDrawable() {
        mDialpadButton.setChecked(false);
    }
    /* End: Modified by zxiaona for display dialpad drawabletop 2012/06/12 */
    /* Begin: Modified by zxiaona for speakButton 2012/06/19 */
    public void enstrueSpeakerOpened() {
        mSpeakerButton.setChecked(false);
    }
    /* End: Modified by zxiaona for speakButton 2012/06/19 */
    /* Begin: Modified by zxiaona for bluetoothButton 2012/07/06 */
    public void setBluetoothIcon(boolean isOpened) {
        mBlueButton.setChecked(isOpened);
    }
    /* End: Modified by zxiaona for bluetoothButton 2012/07/06 */
