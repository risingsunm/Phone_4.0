...
/*Begin: Modified by zxiaona for cdma time 2012/07/30*/
import com.android.internal.telephony.cdma.CdmaInformationRecords.CdmaLineControlInfoRec;
/*End: Modified by zxiaona for cdma time 2012/07/30*/
...
public class InCallScreen extends Activity
   ...
   /* Begin: Modified by zxiaona for IncomingCall Mute 2012/06/25 */
    private static float SAVEVALUE1;
    private static float SAVEVALUE2;
  /* End: Modified by zxiaona for IncomingCall Mute 2012/06/25 */
    ...
    /* Begin: Modified by zxiaona for for_call_endscreen_delay 2012/05/07 */
    // private static final int CALL_ENDED_SHORT_DELAY = 200; // msec
    private static final int CALL_ENDED_SHORT_DELAY = 3000; // msec
    /* End: Modified by zxiaona for for_call_endscreen_delay 2012/05/07 */
    ...
    /*ren_kang.hoperun 2012.7.9 add for resetting timer when the call connect*/
    private static final int PHONE_LINE_CONTROL_INFO = 125;
    /*ren_kang.hoperun 2012.7.9 end*/

    /* Begin: Modified by zxiaona for for_call_endscreen_buttons 2012/04/28 */
    ...
    /* End: Modified by zxiaona for for_call_endscreen_buttons 2012/04/28 */

    /* Begin: Modified by zxiaona for for_call_endscreen_buttons 2012/05/08 */
    public static final String EXTRA_CALL_ORIGIN = "com.android.phone.CALL_ORIGIN";
    public static final String CALL_ORIGIN_DIALTACTS =
            "com.android.contacts.activities.DialtactsActivity";
    /* End: Modified by zxiaona for for_call_endscreen_buttons 2012/05/08 */

    /* Begin: Modified by zxiaona for for_call_endscreen_displayupdate 2012/05/08 */
    private boolean mdisplayNumber = false;
    /* End: Modified by zxiaona for for_call_endscreen_displayupdate 2012/05/08 */
    /* Begin: Modified by zxiaona for reecording 2012/06/20 */
    private static final int OPTION_MENU_ITEM_START_RECORDING = 1;
    ...
    /* End: Modified by zxiaona for IncomingCall Mute 2012/06/25 */
    /* Begin: Modified by zxiaona for smssend 2012/07/21 */
    private int msubscription;
    /* End: Modified by zxiaona for smssend 2012/07/21 */
    /* Begin: Modified by zxiaona for into_contacts 2012/07/25 */
    private static final int OPTION_MENU_ITEM_START_CONTACTS = 2;
    private static final String UP_ACTIVITY_PACKAGE = "com.android.contacts";
    private static final String UP_ACTIVITY_CLASS =
            "com.android.contacts.activities.PeopleActivity";
    /* End: Modified by zxiaona for into_contacts 2012/07/25 */
    /*Begin: Modified by zxiaona for cdma time 2012/07/30*/
    private Call.State mPreviousCallState;
    /*End: Modified by zxiaona for cdma time 2012/07/30*/
    /* Begin: Modified by zxiaona for C notifier time 2012/08/16 */
    private static long time1;
    /* End: Modified by zxiaona for C notifier time 2012/08/16 */
    ...
    protected BluetoothHandsfree mBluetoothHandsfree;
            ...
            switch (msg.what) {
                ...
                case PhoneApp.MMI_COMPLETE:
                    ...
                    if (phoneType == Phone.PHONE_TYPE_CDMA) {
                        PhoneUtils.displayMMIComplete(phone, mApp.mContext, mmiCode, null, null);
    ...
    protected void onCreate(Bundle icicle) {
        ...
        Phone.State ps = mApp.getPhoneState(subscription);
    ...
    /*ren_kang.hoperun 2012.7.9 add for resetting timer when the call connect*/
     protected void resetLineControlInfo(AsyncResult obj) {
        // TODO Auto-generated method stub
        /* Begin: Modified by zxiaona for cdma time 2012/07/30 */
        //mCallCard.resetElapsedTime();
         // Extract the LineControl String from the message
         CdmaLineControlInfoRec lineControlInfoRec = (CdmaLineControlInfoRec)(obj.result);
         if (lineControlInfoRec != null) {
             ...
             if (polarityIncluded ==1){
                ...
                getCurrentTime(chronometerBaseTime);
                /* End: Modified by zxiaona for C notifier time 2012/08/16 */

                 mCallCard.resetElapsedTime();
             }
             resetCDMAIncomingvbri();
             mCallCard.setText();
         }
        /* End: Modified by zxiaona for cdma time 2012/07/30 */

        Log.i(LOG_TAG, "rk_resetLineControlInfo");
    }
     /*ren_kang.hoperun 2012.7.9 end*/
    /* Begin: Modified by zxiaona for C notifier time 2012/08/16 */
    /* package */long getCurrentTime(long time) {
        time1 = time;
        return time1;
    }
    ...
    private final SensorEventListener mSensorListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if((Math.abs(x)< 2) && (Math.abs(y)< 2)&& (5 == SAVEVALUE2))
            {
                SAVEVALUE1 = SAVEVALUE2;
            }
            if((SAVEVALUE1 != 0) && (SAVEVALUE2 != 0) && (SAVEVALUE1 == 5 && 1 == SAVEVALUE2))
            {
    ...
    protected void onResume() {
        ...
        /* Begin: Modified by zxiaona for IncomingCall Mute 2012/06/25 */
        Sensor sensors = mSensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
        boolean checked =Settings.System.getInt(getContentResolver(), "reversal_mute",0) != 0;
        if(checked == true) {
            SAVEVALUE1 = 0;
            SAVEVALUE2 = 0;
        mSensorManager.registerListener(mSensorListener, sensors,SensorManager.SENSOR_DELAY_GAME);
        }
        /* End: Modified by zxiaona for IncomingCall Mute 2012/06/25 */
    ...
    protected void onDestroy() {
        ...
        /* Begin: Modified by zxiaona for IncomingCall Mute 2012/06/26 */
        /* Begin: Modified by sunrise for bug1908 2012/08/14 */
        /*
        if (strRingerMode != defaultRingerMode) {
        ...
        */
        /* End: Modified by sunrise for bug1908 2012/08/14 */
        /* End: Modified by zxiaona for IncomingCall Mute 2012/06/26 */
    ...
    protected void onNewIntent(Intent intent) {
        ...
        /* Begin: Modified by zxiaona for for_call_stateLabel 2012/04/26 */
        if(mCallEnd == null){
            internalResolveIntent(intent);
        }else {
        mCallEnd.setVisibility(View.GONE);
        mCallCard.setBackgroundResource(R.drawable.bg_in_call_gradient_connected);
        mInCallTouchUi.setVisibility(View.VISIBLE);
        }
        /* End: Modified by zxiaona for for_call_stateLabel 2012/04/26 */
        /*Begin: Modified by zxiaona for incomingcall_screen 2012/05/29*/
        //internalResolveIntent(intent);
        /*End: Modified by zxiaona for incomingcall_screen 2012/05/29*/
    ...
    protected void internalResolveIntent(Intent intent) {
        ...
        // state.
        /* Begin: Modified by zxiaona for IncomingCall Mute 2012/06/26 */
        defaultRingerMode = GetAudioManagerMode();
        /* End: Modified by zxiaona for IncomingCall Mute 2012/06/26 */
    ...
    protected void initInCallScreen() {
        ...
        if (TelephonyManager.getDefault().isMultiSimEnabled()) {
            /*Begin: Modified by zxiaona for call_screen_sim 2012/05/17*/
            //mCallCard = (CallCard) findViewById(R.id.mSimCallCard);
            mCallCard = (MSimCallCard) findViewById(R.id.mSimCallCard);
            /*End: Modified by zxiaona for call_screen_sim 2012/05/17*/
    ...
    public void onBackPressed() {
        ...
        /* Begin: Modified by zxiaona for callscreen_back 2012/08/10 */
        Call fgCall = mCM.getActiveFgCall();
        if (fgCall.getState() == Call.State.ACTIVE || fgCall.getState() == Call.State.DIALING
                || fgCall.getState() == Call.State.ALERTING) {
            if (DBG)
                log("BACK key while active: ignored");
            return;
        }
        /* End: Modified by zxiaona for callscreen_back 2012/08/10 */
...
/*Begin: Modified by zxiaona for emergency bug 2012/07/27*/
//        if (phoneIsCdma) {
...
//            }
//        }
/*End: Modified by zxiaona for emergency bug 2012/07/27*/
     ...
     */
    protected void onMMIInitiate(AsyncResult r) {
    ...
    private void addVoiceMailNumberPanel() {
        ...
        intent.setClass(this, MSimCallFeaturesSubSetting.class);
        int subscription = mApp.callController.getVoiceMailSub();
        Log.d(LOG_TAG, "set voice mail for sub:" + subscription);
    ...
    protected void delayedCleanupAfterDisconnect(Phone phone) {
        ...
        if (stayHere) {
            ...
            if (mIsForegroundActivity) {
                ...
                /*
                 * Begin: Modified by zxiaona for bugfree#2420 callendScreen
                 * 2012/08/15
                 */
                // if ((mLastDisconnectCause !=
                ...
                // final Intent intent =
                // mApp.createPhoneEndIntentUsingCallOrigin();
                ...
                // }
                /*
                 * End: Modified by zxiaona for bugfree#2420 callendScreen
                 * 2012/08/15
                 */

                /* Begin: Modified by zxiaona for call_end_screen 2012/04/07 */
                //updateUi();
                /* End: Modified by zxiaona for call_end_screen 2012/04/07 */
                endInCallScreenSession();
            }
        ...
        if (isBluetoothAvailable()) {
            ...
            if (isBluetoothAudioConnected()) {
                ...
                if (PhoneUtils.isSpeakerOn(this)) {
                    ...
                    /* Begin: Modified by zxiaona for bug bluetooth 2012/07/20 */
                    mInCallTouchUi.enstrueSpeakerOpened();
                    /* End: Modified by zxiaona for bug bluetooth 2012/07/20 */
    ...
    public void switchInCallAudio(InCallAudioMode newMode) {
        ...
        switch (newMode) {
            case SPEAKER:
                ...
                // /* Begin: Modified by zxiaona for speakButton 2012/06/18 */
                // // if (!PhoneUtils.isSpeakerOn(this)) {
                ...
                // // }
                // boolean newSpeakerState = PhoneUtils.isSpeakerOn(this);
                // if (newSpeakerState == false) {
                // PhoneUtils.turnOnSpeaker(this, true, true);
                // } else {
                // PhoneUtils.turnOnSpeaker(this, false, true);
                // }
                // /* End: Modified by zxiaona for speakButton 2012/06/18 */
                toggleSpeaker();
                /* End: Modified by zxiaona for bug bluetooth 2012/07/20 */
                break;
            ...
            case BLUETOOTH:
                ...
                /* Begin: Modified by zxiaona for bluetoothButton 2012/07/06 */
                // if (isBluetoothAvailable() && !isBluetoothAudioConnected()) {
                // // Manually turn the speaker phone off, instead of allowing
                // the
                // // Bluetooth audio routing to handle it, since there's other
                // // important state-updating that needs to happen in the
                // // PhoneUtils.turnOnSpeaker() method.
                ...
                // }
                toggleBluetooth();
                /* End: Modified by zxiaona for bluetoothButton 2012/07/06 */
                break;
    ...
    /* package */ void handleOnscreenButtonClick(int id) {
        ...
        /* Begin: Modified by zxiaona for G mutil hold 2012/08/13 */
        InCallControlState inCallControlState = getUpdatedInCallControlState();
        boolean ismerge = inCallControlState.canMerge;
        /* End: Modified by zxiaona for G mutil hold 2012/08/13 */
        /* Begin: Modified by zxiaona for C mutil hold 2012/08/13 */
        boolean isSwap = inCallControlState.canSwap;
        /* End: Modified by zxiaona for C mutil hold 2012/08/13 */
        ...
        switch (id) {
            ...
            case R.id.holdButton:
                ...
                /* Begin: Modified by zxiaona for C mutil hold 2012/08/13 */
                // if (ismerge == true) {
                if (ismerge == true || mCM.getFgPhone().getPhoneType() == Phone.PHONE_TYPE_CDMA
                        && isSwap == true) {
                    /* End: Modified by zxiaona for C mutil hold 2012/08/13 */
                    showToast();
                } else {
            ...
            case R.id.cdmaMergeButton:
                /*Begin: Modified by zxiaona for mutil_call 2012/08/03*/
            case R.id.cdmaMergeButtonImage:
                /*End: Modified by zxiaona for mutil_call 2012/08/03*/
            ...
            case R.id.manageConferenceButton:
                ...
                requestUpdateScreen();
                break;
            /* Begin: Modified by zxiaona for for_call_endscreen_buttons 2012/04/27 */
            ...
            case R.id.smsButton:
                smsSend();
                break;
            /* End: Modified by zxiaona for for_call_endscreen_buttons 2012/04/27 */
            /* Begin: Modified by zxiaona for speakButton 2012/06/18 */
            case R.id.speakerButton:
                switchInCallAudio(InCallScreen.InCallAudioMode.SPEAKER);
                break;
                /* End: Modified by zxiaona for speakButton 2012/06/18 */
                /* Begin: Modified by zxiaona for bluetoothButton 2012/07/06 */
            case R.id.bluetoothButton:
                switchInCallAudio(InCallScreen.InCallAudioMode.BLUETOOTH);
                break;
                /* End: Modified by zxiaona for bluetoothButton 2012/07/06 */
            default:
    ...
    /* package */ void hangupRingingCall() {
        ...
        // it to always act on the first ringing call.
        /*Begin: Modified by zxiaona for incomingcall_screen 2012/05/29*/
//        mCallCard.setBackgroundResource(R.drawable.bg_in_call_gradient_ended);
//        mCallEnd.setVisibility(View.VISIBLE);
        /*End: Modified by zxiaona for incomingcall_screen 2012/05/29*/
    ...
    /* Begin: Modified by zxiaona for call_end_screen 2012/04/06 */
    ...
    protected void updateUi() {
        Log.i("*** InCallScreen ***", "** updateUi() **");
        Thread t = new Thread() {
            public void run() {
                callendHandler.post(mUpdateUi);
            }
        };
        t.start();
    }
    /* End: Modified by zxiaona for call_end_screen 2012/04/06 */
    ...
    protected void setInCallScreenMode(InCallScreenMode newMode) {
        ...
        switch (newMode) {
            ...
            case CALL_ENDED:
                ...
                /* Begin: Modified by zxiaona for for_call_endscreen_buttons 2012/05/07 */
                if(isDialerOpened()) {
                    hideDialpadInternal(true);
                    mInCallTouchUi.hideDialDrawable();
                }
                mCallCard.setBackgroundResource(R.drawable.bg_in_call_gradient_ended);
                mInCallTouchUi.setVisibility(View.GONE);
                /* Begin: Modified by zxiaona for internal_icon 2012/05/31 */
                mCallCard.setInternalIcon();
                /* End: Modified by zxiaona for internal_icon 2012/05/31 */
                initCallEnd();
                /* Begin: Modified by zxiaona for for_call_endscreen_displayupdate 2012/05/08 */
                mCallEnd.setVisibility(View.VISIBLE);
                mCallEnd.updateCallEnd(mdisplayNumber);
                /* End: Modified by zxiaona for for_call_endscreen_displayupdate 2012/05/08 */

                /* End: Modified by zxiaona for for_call_endscreen_buttons 2012/05/07 */
                mInCallPanel.setVisibility(View.VISIBLE);
                /* Begin: Modified by zxiaona for speakButton 2012/06/19 */
                isSpeakerOpened();
                /* End: Modified by zxiaona for speakButton 2012/06/19 */
                ...
                /* Begin: Modified by zxiaona for bluetoothButton 2012/07/06 */
                if (!isBluetoothAudioConnected()) {
                    mInCallTouchUi.setBluetoothIcon(false);
                }
                /* End: Modified by zxiaona for bluetoothButton 2012/07/06 */

                /* End: Modified by zxiaona for recording 2012/06/27 */
    ...
    /* Begin: Modified by zxiaona for callScreen_btnicon 2012/06/01 */
    /* packages */boolean okToShowSpeaker() {
        return okToSpeaker();
    }

    private boolean okToSpeaker() {
        final boolean hasRingingCall = mCM.hasActiveRingingCall();
        final Call.State fgCallState = mCM.getActiveFgCallState();
        final  Call bgCall = mCM.getFirstActiveBgCall();
        boolean canSpeaker =
                (fgCallState == Call.State.ACTIVE || fgCallState == Call.State.ALERTING || fgCallState == Call.State.DIALING
    ...
    /* packages */boolean okToShowEndCall() {
        return okToShowEnd();
    }

    private boolean okToShowEnd() {
        final boolean hasRingingCall = mCM.hasActiveRingingCall();
        final Call.State fgCallState = mCM.getActiveFgCallState();
        final  Call bgCall = mCM.getFirstActiveBgCall();
        boolean canEnd =
                (fgCallState == Call.State.ACTIVE || fgCallState == Call.State.ALERTING || bgCall.getState() == Call.State.HOLDING)
                        && !hasRingingCall
                        && (mApp.inCallUiState.inCallScreenMode != InCallScreenMode.MANAGE_CONFERENCE);
        return canEnd;
    }
    ...
    boolean endDisconn() {
        ...
        final Call.State fgCallState = mCM.getActiveFgCallState();
        boolean endDis =
                (fgCallState == Call.State.DISCONNECTED || fgCallState == Call.State.DISCONNECTING)
                        && !hasRingingCall
                        && (mApp.inCallUiState.inCallScreenMode != InCallScreenMode.MANAGE_CONFERENCE);
        return endDis;
    }
    ...
    /* End: Modified by zxiaona for callScreen_btnicon 2012/06/01 */
    ...
    /* Begin: Modified by zxiaona for call_end_screen 2012/04/01 */
    private void initCallEnd() {
        mCallEnd = (CallEnd) findViewById(R.id.callEnd);
        mCallEnd.setInCallScreenInstance(this);
    }
    /* End: Modified by zxiaona for call_end_screen 2012/04/01 */
    /**
    ...
    /* package */ void disconnectBluetoothAudio() {
        ...
        mBluetoothConnectionPending = false;
        /* Begin: Modified by zxiaona for bluetoothButton 2012/07/06 */
        mInCallTouchUi.setBluetoothIcon(true);
        /* End: Modified by zxiaona for bluetoothButton 2012/07/06 */
    }
    ...
    /* Begin: Modified by zxiaona for for_call_endscreen_displayupdate 2012/05/08 */
    public void setTargetPhoneNumber(String targetPhoneNumber, boolean displayNumber) {
        mPhoneNumber = targetPhoneNumber;
        mdisplayNumber = displayNumber;
        Log.i("***********", "*************mPhoneNumber = " + mPhoneNumber + "mdisplayNumber ="
                + mdisplayNumber);
    }
    /* End: Modified by zxiaona for for_call_endscreen_displayupdate 2012/05/08 */

    /* Begin: Modified by zxiaona for bug for C . G call 2012/08/14 */
    /*package*/ boolean getNumberType() {
        return getNumberType(mPhoneNumber);
    }
    private boolean getNumberType(String isEcNumber) {
        boolean isEmergencyNumber = PhoneNumberUtils.isEmergencyNumber(isEcNumber);
        return isEmergencyNumber;
    }
    /* End: Modified by zxiaona for bug for C . G call 2012/08/14 */

    /* Begin: Modified by zxiaona for for_call_endscreen_buttons 2012/05/03 */
    private void addNewContacts()
    {
        ...
        intent.putExtra(Insert.PHONE, mPhoneNumber);
        startActivity(intent);
    }
    ...
    private void refreshContacts()
    {
        ...
        long value = 0;
        Cursor cs = getContentResolver().query(Contacts.CONTENT_URI, contactId, null, null, null);
        ...
        it.setAction(JOIN_CONTACT);
        it.putExtra(EXTRA_TARGET_CONTACT_ID, value);
        it.putExtra("number", mPhoneNumber);
        startActivity(it);
    }

    /* Begin: Modified by zxiaona for smssend 2012/07/21 */
    public void getSubscription(int subscription) {
    ...
    private void smsSend() {
        Intent intent = new Intent(Intent.ACTION_SENDTO,
                Uri.fromParts("sms", mPhoneNumber, null));
        intent.putExtra("send_subscription", msubscription);
        startActivity(intent);
    }
    ...
    /* End: Modified by zxiaona for for_call_endscreen_buttons 2012/05/03 */
    /* Begin: Modified by zxiaona for speakButton 2012/06/19 */
    private void isSpeakerOpened() {
        if (PhoneUtils.isSpeakerOn(this)) {
            mInCallTouchUi.enstrueSpeakerOpened();
        } else {
            return;
    ...
    /* End: Modified by zxiaona for speakButton 2012/06/19 */
    /* Begin: Modified by zxiaona for recording 2012/06/19 */
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0,R.id.mergeButton,0,R.string.onscreenMergeCallsText).setIcon(R.drawable.call_menu_merge);
        menu.add(0,R.id.swapButton,0,R.string.onscreenSwapCallsText).setIcon(R.drawable.call_menu_swap);
        menu.add(0, R.id.addButton, 0,R.string.onscreenAddCallText).setIcon(R.drawable.call_menu_add);
        menu.add(0, OPTION_MENU_ITEM_START_RECORDING, 0, R.string.start_record).setIcon(R.drawable.call_menu_recorder);
        menu.add(0,OPTION_MENU_ITEM_START_CONTACTS,0,R.string.people).setIcon(R.drawable.call_menu_contacts);
        return true;
    }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem addItem = menu.findItem(R.id.addButton);
        MenuItem mergeItem = menu.findItem(R.id.mergeButton);
        MenuItem swapItem = menu.findItem(R.id.swapButton);
        PhoneRecorder phoneRecorder = PhoneRecorder.getInstance(this.getApplicationContext());
        recordItem.setVisible(true);
        addItem.setVisible(true);
        /*Begin: Modified by zxiaona for into_contacts 2012/07/25*/
        MenuItem contactsItem = menu.findItem(OPTION_MENU_ITEM_START_CONTACTS);
        contactsItem.setVisible(true);
        /*End: Modified by zxiaona for into_contacts 2012/07/25*/
            log("fgCall.getState():" + mCM.getActiveFgCall().getState());
            log("mCM.getFgPhone().getPhoneType():" + mCM.getFgPhone().getPhoneType());
            Call fgCall = mCM.getActiveFgCall();
            if (fgCall.getState() != Call.State.ACTIVE || fgCall.getState() == Call.State.ACTIVE
                    && mCM.getFgPhone().getPhoneType() == Phone.PHONE_TYPE_SIP) {
                log("set record item disabled");
                recordItem.setVisible(false);
                addItem.setVisible(false);
                swapItem.setVisible(false);
                mergeItem.setVisible(false);
                /* Begin: Modified by zxiaona for into_contacts 2012/07/25 */
                contactsItem.setVisible(false);
                /* End: Modified by zxiaona for into_contacts 2012/07/25 */
            } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case OPTION_MENU_ITEM_START_RECORDING:
                ...
                return true;
                /* Begin: Modified by zxiaona for into_contacts 2012/07/25 */
            case OPTION_MENU_ITEM_START_CONTACTS:
                openContacts();
                return true;
            case R.id.swapButton:
                internalSwapCalls();
     ...
     *
     * @param dismissImmediate If true, hide the panel immediately. If false,
     *            leave the menu visible onscreen for a brief interval before
     *            dismissing it (so the user can see the state change resulting
     *            from his original click.)
     */
    ...
    private void startRecord() {
        Log.e("==============", "mRecorderServiceIntent = " + mRecorderServiceIntent);
        Log.e("==============", "PhoneApp.getInstance() = " + PhoneApp.getInstance());
        startService(mRecorderServiceIntent);
    ...
    private void stopRecord() {
        stopService(mRecorderServiceIntent);
        updateCallCard(false);
    }

    private void updateCallCard(boolean showIcon) {
        final boolean isShow = showIcon;
        final Handler showIconhandler = new Handler();
        final Runnable mUpdateRecord = new Runnable() {
            public void run() {
                mCallCard.showRecordIcon(isShow);
            }
        };
        Thread t = new Thread() {
            public void run() {
                try {
                    Thread.sleep(500);
                    showIconhandler.post(mUpdateRecord);
    ...
    /* End: Modified by zxiaona for recording 2012/06/19 */
    ...
    /* End: Modified by zxiaona for into_contacts 2012/07/25 */
    /*Begin: Modified by zxiaona for cdma time 2012/07/30*/
    public void resetCDMAIncomingvbri() {
       Phone fgPhone = mCM.getFgPhone();
       mPreviousCallState = fgPhone.getForegroundCall().getState();

       /* Begin: Modified by sunrise for CallVibrate 2012/08/014 */
       boolean isDialpadToneEnable = Settings.System.getInt(fgPhone.getContext().getContentResolver(),
                  "hook_vibrate_hint_enable", 1) == 1;
       System.out.println("isDialpadToneEnable:" + isDialpadToneEnable);
       if (isDialpadToneEnable)
       {
           Vibrator vbr = (Vibrator) fgPhone.getContext().getSystemService(
               Context.VIBRATOR_SERVICE);
           vbr.vibrate(300);
       }
       /* End: Modified by sunrise for CallVibrate 2012/08/14 */
    }
   /*End: Modified by zxiaona for cdma time 2012/07/30*/
    /* Begin: Modified by zxiaona for G mutil hold 2012/08/13 */
    private void showToast() {
        Toast toast = Toast.makeText(this, R.string.mutil_call_hold, Toast.LENGTH_LONG);
        toast.show();
    }
