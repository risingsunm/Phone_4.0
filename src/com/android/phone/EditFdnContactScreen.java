    ...
    private View.OnClickListener mClicked = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (v == mNameField) {
                ...
                mNameField.performClick();
                mNumberField.performClick();
                if (TextUtils.isEmpty(mNameField.getText()) || TextUtils.isEmpty(mNumberField.getText())) {
