...
public class MSimPhoneApp extends PhoneApp {
    ...
    private Uri uri = Uri.parse(CONTENT_URI_INFO);
    /*zhanglu.hoperun 2012.7.11 end*/
    ...
    public void onCreate() {
        ...
        /*zhanglu.hoperun 2012.7.11 add to save prlversion in contentprovider*/
        String prlversion = MSimPhoneFactory.getPhone(0).getCdmaPrlVersion();
        String esn = MSimPhoneFactory.getPhone(0).getEsn();
        ContentValues values = new ContentValues();
        values.put("prl", prlversion);
        values.put("esn", esn);
    ...
    //inti cdma call state if the phone type is cdma type
    private void initPhoneAppCdmaCallState(int subscription) {
        SinglePhone singlePhone = getSinglePhone(subscription);
        if ((singlePhone != null) &&(singlePhone.mPhone.getPhoneType() == Phone.PHONE_TYPE_CDMA)) {
