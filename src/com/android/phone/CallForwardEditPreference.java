...
import static com.android.phone.TimeConsumingPreferenceActivity.NOT_OPEN_SERVER;
        ...
        private void handleGetCFResponse(Message msg) {
            ...
            if (ar.exception != null) {
                ...
                if (ar.userObj instanceof Throwable) {
                    /*Begin: Modified by siliangqi for not_open_operation 2012-8-14*/
                    tcpListener.onError(CallForwardEditPreference.this, NOT_OPEN_SERVER);
                    /*End: Modified by siliangqi for not_open_operation 2012-8-14*/
                }
