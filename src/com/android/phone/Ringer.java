                ...
                public void handleMessage(Message msg) {
                    ...
                    switch (msg.what) {
                        case PLAY_RING_ONCE:
                            ...
                            // if the ringtone is silent, make it didn't play.
                            if (mCustomRingtoneUri.toString().startsWith(Settings.System.DEFAULT_RINGTONE_URI.toString())) {
                                String scription = mCustomRingtoneUri.getLastPathSegment();
                                String ringUri = Settings.System.getString(mContext.getContentResolver(), scription);
                                if (TextUtils.isEmpty(ringUri)) {
                                    Log.w(LOG_TAG, "the real ringUri : " + ringUri);
                                    break;
                                }
                            }
