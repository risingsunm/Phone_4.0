...
/* Begin: Modified by zxiaona for incomingcall_screen 2012/05/28 */
/**
...
public class SlidingTab extends ViewGroup {
    ...
    public interface OnTriggerListener {
         ...
         *            {@link #LEFT_HANDLE}, or {@link #RIGHT_HANDLE}.
         */
     ...
     * consists of 3 Views: {@link #tab} is the tab shown on the screen in the
     * default state. {@link #text} is the view revealed as the user slides the
     * tab out. {@link #target} is the target the user must drag the slider past
    ...
    private static class Slider {
        ...
        Slider(ViewGroup parent, int tabId, int barId, int targetId) {
            ...
            text.setLayoutParams(new LayoutParams(480,
            ...
            // com.android.internal.R.style.TextAppearance_SlidingTabNormal);
            // hint.setSingleLine(); // Hmm.. this causes the text to disappear
            // off-screen
        ...
        void setState(int state) {
            ...
            if (state == STATE_ACTIVE) {
                ...
                // com.android.internal.R.style.TextAppearance_SlidingTabActive);
            } else {
                // text.setTextAppearance(text.getContext(),
                // com.android.internal.R.style.TextAppearance_SlidingTabNormal);
            }
        ...
        void layout(int l, int t, int r, int b, int alignment) {
            ...
            // final int leftTarget = (int) (THRESHOLD * parentWidth) -
            // targetWidth + handleWidth / 2;
            // final int rightTarget = (int) ((1.0f - THRESHOLD) * parentWidth)
            // - handleWidth / 2;
            final int left = (parentWidth - handleWidth) / 2;
            final int right = left + handleWidth;
            log(" Slider  alignment == ALIGN_LEFT  parentWidth:" + parentWidth);
            if (alignment == ALIGN_LEFT || alignment == ALIGN_RIGHT) {
                ...
                if (alignment == ALIGN_LEFT) {
                    ...
                    // target.layout(leftTarget, targetTop, leftTarget +
                    ...
                    // target.layout(rightTarget, targetTop, rightTarget +
                    // targetWidth, targetBottom);
         ...
         * ValueAnimator keeps internal state of the invalidation region which
         * is just the view being animated.
         *
         * @param anim1
         * @param anim2
         */
    ...
    public SlidingTab(Context context, AttributeSet attrs) {
        ...
        mLeftSlider = new Slider(this,
                R.drawable.jog_tab_left_bg,
                R.drawable.jog_tab_left_bg_press,
                0);
        mLeftSlider.setIcon(R.drawable.ic_answer);

        mRightSlider = new Slider(this,
                R.drawable.jog_tab_right_bg,
                R.drawable.jog_tab_right_bg_press,
                0);
        mRightSlider.setIcon(R.drawable.ic_hangup);
    ...
    private void resetView() {
        ...
        // onLayout(true, getLeft(), getTop(), getLeft() + getWidth(), getTop()
        // + getHeight());
    }
...
/* End: Modified by zxiaona for incomingcall_screen 2012/05/28 */
