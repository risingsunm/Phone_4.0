...
public class Settings extends PreferenceActivity implements DialogInterface.OnClickListener,
    ...
    private static final String KEY_FMC_ENABLED = "toggle_fmc";
    ...
    private CheckBoxPreference mFmcCheckbox;
    private Preference mLteDataServicePref;
    private FmcEnabler mFmcEnabler = null;

    private Preference mButtonDataUsage;
    private DataUsageListener mDataUsageListener;
    private static final String iface = "rmnet0"; //TODO: this will go away

    public static final boolean fmcEnalbe = isModemSupportFMC();
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (mGsmUmtsOptions != null &&
            ...
            return true;
        } else if (preference == mFmcCheckbox) {
            // mFmcCheckbox will be handled in the FmcEnalber
            return true;
        }else {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mFmcCheckbox = (CheckBoxPreference) findPreference(KEY_FMC_ENABLED);
        if (!fmcEnalbe) {
            getPreferenceScreen().removePreference(mFmcCheckbox);
        } else {
            mFmcEnabler = new FmcEnabler(this,mFmcCheckbox);
        }
    }
