...
public class MSimSettings extends PreferenceActivity implements DialogInterface.OnClickListener,
    ...
    /*Begin: Modified by siliangqi for not_open_operation 2012-8-21*/
    private boolean isokClicked;
    /*End: Modified by siliangqi for not_open_operation 2012-8-21*/
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mButtonDataRoam) {
            ...
            if (mButtonDataEnabled.isChecked()) {
                isokClicked = false;
            new AlertDialog.Builder(this).setMessage(
                    getResources().getString(R.string.data_warning))
                    .setTitle(android.R.string.dialog_alert_title)
                    .setIcon(android.R.drawable.ic_dialog_alert)
