...
/*Begin: Modified by sunrise for SimSelect 2012/07/20*/
import android.content.DialogInterface.OnCancelListener;
import android.content.DialogInterface.OnClickListener;
import android.provider.ContactsContract;
import android.database.Cursor;
import android.net.Uri;
/*End: Modified by sunrise for SimSelect 2012/07/20*/
...
public class MSimDialerActivity extends Activity {
    ...
    protected void onResume() {
        ...
        Uri uri = Uri.withAppendedPath(
                ContactsContract.PhoneLookup.CONTENT_FILTER_URI, mNumber);
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case INDEX_MULTI_SIM_DIALOG:
                ...
                /*Begin: Modified by sunrise for SimSelect 2012/07/20*/
                mTextNumber = (TextView) multiDialerlayout
                        .findViewById(R.id.CallNumber);
                ...
                else
                {
                    if (mName != null)
                    {
                        mTextNumber.setText(mCallNumber + mName);
                    }
                    else
                    {
                ...
                builder.setCustomTitle(multiDialerlayout);
                final String[] SimType = {
                        "CDMA" + getResources().getString(R.string.dial_up_ext),
                        "GSM" + getResources().getString(R.string.dial_up_ext) };
                builder.setItems(SimType, new OnClickListener()
                {
                    @Override
    ...
    protected void onPrepareDialog(int id, Dialog dialog) {
        switch (id) {
            case INDEX_MULTI_SIM_DIALOG:
                ...
                /*Begin: Modified by sunrise for time count 2012/08/10*/
                //if (isAddTimer()) {
                if (false) {
                /*End: Modified by sunrise for time count 2012/08/10*/
