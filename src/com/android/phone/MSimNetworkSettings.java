...
//        if (mGsmUmtsOptions != null) mGsmUmtsOptions.enableScreen();
    ...
    private void setScreenState() {
        ...
        int simState = android.telephony.MSimTelephonyManager.getDefault().getSimState(mSubscription);
        log("sub " + mSubscription + " state " + simState);
        boolean enableScreen = !(simState == TelephonyManager.SIM_STATE_ABSENT
                || simState == TelephonyManager.SIM_STATE_UNKNOWN || airplane);
        getPreferenceScreen().setEnabled(enableScreen);
        /*
        ...
        if (mSubscription == 1 && mButtonPrefer2g != null) {
