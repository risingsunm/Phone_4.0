...
public class InCallControlState {
    ...
    public boolean isOkBluth;
    public boolean endDisconn;
    ...
    public void update() {
        ...
        /* Begin: Modified by zxiaona for callScreen_btnicon 2012/05/31 */
        // canEndCall = true;
        canEndCall = mInCallScreen.okToShowEndCall();
        isShowEnable = mInCallScreen.endState();
        endDisconn = mInCallScreen.endDisconn();
        canSpeaker = mInCallScreen.okToShowSpeaker();
        /* End: Modified by zxiaona for callScreen_btnicon 2012/05/31 */
        ...
        if (TelephonyCapabilities.supportsHoldAndUnhold(mCM.getPhoneInCall())) {
            ...
            canHold = mInCallScreen.isHold();
            supportsHold = canHold;
            ...
            /* Begin: Modified by zxiaona for inComingCallScreen 2012/06/06 */
            // supportsHold = false;
            supportsHold = false;
            /* End: Modified by zxiaona for inComingCallScreen 2012/06/06 */
